...
3. Перечисленные далее переменный не обязательно корректировать при добавлении нового пункта в бланк объявления, но корректировка потребуется при удалении пункта из бланка.
