...
5. Создать виртуальное окружение для бота. В командной строке перейтив директорию `RealtyChatBot`:\
 `cd RealtyChatBot`\
...
10. На этом шаге можно запустить бота командой `python bot.py`\ и далее перейти в Telegram, чтобы обратиться к нему по зарегистрированному имени (см. подпункт 1 раздела 4.2.)\
